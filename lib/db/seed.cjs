...
async function main() {
  ...
  if (Number(katCount.rows[0].c) === 0) {
    ...
    // single-female Dewasa (Ibu-Ibu). Colors follow the project's red
    // palette (see tailwind.config.ts: primary=#E11D1D, light=#FCE0E0,
    // dark=#9D1010, accent=#F18181) so fresh DBs match the brand.
    const kats = [
      ...
      ["k_anak_l",   "Anak (Laki-laki)",    "fa-child",        5,  11,   1, 0, "#E11D1D", "#FFFFFF", "#9D1010"],
